...
return [
    ...
    'onboarding' => [
        'email_02' => [
            ...
            'greeting' => 'Hey :name,',
            'intro' => 'Day 2 of your plan, nice work. :workout is on today.',
            'tip' => 'Quick tip to start: take your first 2 to 3 sets to find your weight. Better to start a little lighter. Getting the movement right matters more than the number on the bar.',
            'pdf_gap' => 'What the PDF can\'t do: if the bench is taken or an exercise doesn\'t work today, your plan stays rigid. You\'re stuck.',
            'app_bridge' => 'The app runs the same plan, it just thinks along:',
            'feature_swap' => 'Bench taken? Swapped for an equal exercise in 2 seconds.',
            'feature_checkin' => 'Plan adapts when your training changes.',
            'feature_tracking' => 'Progress tracks itself automatically. No notepad, no writing things down.',
            'app_reassure' => 'Your PDF plan just keeps running in the app. You lose nothing, the flexibility comes on top.',
            'banner_alt' => 'The fytrr app',
            'workout_fallback' => 'your workout',
            'cta' => 'Get the app and start :workout',
