...
class HandleInertiaRequests extends Middleware
{
    ...
    private function getFooterLinks(string $locale, array $alternateUrls): array
    {
        ...
        $links = [
            ...
            'macroCalculatorUrl' => LaravelLocalization::localizeURL('/'.trans('routes.free_tools_macro_calculator', [], $locale), $locale),
        ...
        $links['labels'] = [
            ...
            'macroCalculator' => trans('footer.product.macro_calculator', [], $locale),
